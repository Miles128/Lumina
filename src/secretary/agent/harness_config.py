...
class HarnessConfig(BaseModel):
    ...
    # Backend selection: ``agents_sdk`` is now the only turn backend (native
    # HITL + RunState persistence). The in-house AgentLoop survives solely as
    # the spawn_subagent isolation engine + legacy-pause resume fallback.
