...
import os
from .utils.tools import Tools, ApprovalRequiredError
        ...
        **kwargs,
        ...
        while turns < max_turns:
            ...
            try:
                ...
                # Lumina fork: attach conversation so far for pause/resume.
                pending_messages = list(messages)
                pending_messages.append(response.choices[0].message)
                exc.pending_messages = pending_messages
